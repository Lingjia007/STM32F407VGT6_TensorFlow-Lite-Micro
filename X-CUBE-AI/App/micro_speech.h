/**
  ...
  ******************************************************************************
  */
#ifndef AI_MICRO_SPEECH_H
#define AI_MICRO_SPEECH_H

#include "micro_speech_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MICRO_SPEECH_MODEL_NAME          "micro_speech"
#define AI_MICRO_SPEECH_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_MICRO_SPEECH_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MICRO_SPEECH_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MICRO_SPEECH_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MICRO_SPEECH_IN_NUM        (1)

AI_DEPRECATED
#define AI_MICRO_SPEECH_IN \
  ai_micro_speech_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MICRO_SPEECH_IN_SIZE { \
  AI_MICRO_SPEECH_IN_1_SIZE, \
}
#define AI_MICRO_SPEECH_IN_SIZE_BYTES { \
  AI_MICRO_SPEECH_IN_1_SIZE_BYTES, \
}
#define AI_MICRO_SPEECH_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_MICRO_SPEECH_IN_1_CHANNEL     (1960)
#define AI_MICRO_SPEECH_IN_1_SIZE        (1960)
#define AI_MICRO_SPEECH_IN_1_SIZE_BYTES  (1960)

/******************************************************************************/
#define AI_MICRO_SPEECH_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MICRO_SPEECH_OUT \
  ai_micro_speech_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MICRO_SPEECH_OUT_SIZE { \
  AI_MICRO_SPEECH_OUT_1_SIZE, \
}
#define AI_MICRO_SPEECH_OUT_SIZE_BYTES { \
  AI_MICRO_SPEECH_OUT_1_SIZE_BYTES, \
}
#define AI_MICRO_SPEECH_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_MICRO_SPEECH_OUT_1_CHANNEL     (36)
#define AI_MICRO_SPEECH_OUT_1_SIZE        (36)
#define AI_MICRO_SPEECH_OUT_1_SIZE_BYTES  (36)

/******************************************************************************/
#define AI_MICRO_SPEECH_N_NODES (28)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup micro_speech
...
AI_DEPRECATED
AI_API_ENTRY
ai_bool ai_micro_speech_get_info(
 ...
 */
AI_API_ENTRY
ai_bool ai_micro_speech_get_report(
  ai_handle network, ai_network_report* report);
 ...
 */
AI_API_ENTRY
ai_error ai_micro_speech_get_error(ai_handle network);
 ...
 */
AI_API_ENTRY
ai_error ai_micro_speech_create(
 ...
 */
AI_API_ENTRY
ai_handle ai_micro_speech_destroy(ai_handle network);
 ...
 * @ref ai_micro_speech_create. Both the activations memory buffer 
 ...
 * using @ref ai_micro_speech_get_error
 */
AI_API_ENTRY
ai_bool ai_micro_speech_init(
 ...
 */
AI_API_ENTRY
ai_error ai_micro_speech_create_and_init(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_micro_speech_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_micro_speech_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MICRO_SPEECH_*
 * defines into file @ref micro_speech.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_micro_speech_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_MICRO_SPEECH_H */
