/**
  ...
  ******************************************************************************
  */
#ifndef AI_HELLO_WORLD_H
#define AI_HELLO_WORLD_H

#include "hello_world_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_HELLO_WORLD_MODEL_NAME          "hello_world"
#define AI_HELLO_WORLD_ORIGIN_MODEL_NAME   "hello_world_int8_cos"

/******************************************************************************/
#define AI_HELLO_WORLD_ACTIVATIONS_ALIGNMENT   (4)
#define AI_HELLO_WORLD_INPUTS_IN_ACTIVATIONS   (4)
#define AI_HELLO_WORLD_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_HELLO_WORLD_IN_NUM        (1)

AI_DEPRECATED
#define AI_HELLO_WORLD_IN \
  ai_hello_world_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_HELLO_WORLD_IN_SIZE { \
  AI_HELLO_WORLD_IN_1_SIZE, \
}
#define AI_HELLO_WORLD_IN_SIZE_BYTES { \
  AI_HELLO_WORLD_IN_1_SIZE_BYTES, \
}
#define AI_HELLO_WORLD_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_HELLO_WORLD_IN_1_CHANNEL     (1)
#define AI_HELLO_WORLD_IN_1_SIZE        (1)
#define AI_HELLO_WORLD_IN_1_SIZE_BYTES  (1)

/******************************************************************************/
#define AI_HELLO_WORLD_OUT_NUM       (1)

AI_DEPRECATED
#define AI_HELLO_WORLD_OUT \
  ai_hello_world_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_HELLO_WORLD_OUT_SIZE { \
  AI_HELLO_WORLD_OUT_1_SIZE, \
}
#define AI_HELLO_WORLD_OUT_SIZE_BYTES { \
  AI_HELLO_WORLD_OUT_1_SIZE_BYTES, \
}
#define AI_HELLO_WORLD_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_HELLO_WORLD_OUT_1_CHANNEL     (1)
#define AI_HELLO_WORLD_OUT_1_SIZE        (1)
#define AI_HELLO_WORLD_OUT_1_SIZE_BYTES  (1)

/******************************************************************************/
#define AI_HELLO_WORLD_N_NODES (4)
 ...
 * @ref ai_hello_world_create. Both the activations memory buffer 
 ...
 * using @ref ai_hello_world_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_hello_world_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_hello_world_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_HELLO_WORLD_*
 * defines into file @ref hello_world.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_hello_world_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_HELLO_WORLD_H */
