...
#define AI_HELLO_WORLD_DATA_ACTIVATIONS_START_ADDR 0xFFFFFFFF
#define AI_MICRO_SPEECH_QUANTIZED_DATA_ACTIVATIONS_START_ADDR 0xFFFFFFFF

#define AI_MNETWORK_DATA_ACTIVATIONS_INT_SIZE AI_MICRO_SPEECH_QUANTIZED_DATA_ACTIVATIONS_SIZE
