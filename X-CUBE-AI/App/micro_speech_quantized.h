/**
  ...
  ******************************************************************************
  */
#ifndef AI_MICRO_SPEECH_QUANTIZED_H
#define AI_MICRO_SPEECH_QUANTIZED_H
...
#define AI_MICRO_SPEECH_QUANTIZED_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MICRO_SPEECH_QUANTIZED_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MICRO_SPEECH_QUANTIZED_IN_NUM        (1)

AI_DEPRECATED
#define AI_MICRO_SPEECH_QUANTIZED_IN \
  ai_micro_speech_quantized_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MICRO_SPEECH_QUANTIZED_IN_SIZE { \
  AI_MICRO_SPEECH_QUANTIZED_IN_1_SIZE, \
}
#define AI_MICRO_SPEECH_QUANTIZED_IN_SIZE_BYTES { \
  AI_MICRO_SPEECH_QUANTIZED_IN_1_SIZE_BYTES, \
}
#define AI_MICRO_SPEECH_QUANTIZED_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_MICRO_SPEECH_QUANTIZED_IN_1_CHANNEL     (1960)
#define AI_MICRO_SPEECH_QUANTIZED_IN_1_SIZE        (1960)
#define AI_MICRO_SPEECH_QUANTIZED_IN_1_SIZE_BYTES  (1960)

/******************************************************************************/
#define AI_MICRO_SPEECH_QUANTIZED_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MICRO_SPEECH_QUANTIZED_OUT \
  ai_micro_speech_quantized_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MICRO_SPEECH_QUANTIZED_OUT_SIZE { \
  AI_MICRO_SPEECH_QUANTIZED_OUT_1_SIZE, \
}
#define AI_MICRO_SPEECH_QUANTIZED_OUT_SIZE_BYTES { \
...
/*!
 * @defgroup micro_speech_quantized
 ...
 * @ingroup micro_speech_quantized
 ...
 * @ref ai_micro_speech_quantized_create. Both the activations memory buffer 
 ...
 * using @ref ai_micro_speech_quantized_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_micro_speech_quantized_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_micro_speech_quantized_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MICRO_SPEECH_QUANTIZED_*
 * defines into file @ref micro_speech_quantized.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_micro_speech_quantized_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_MICRO_SPEECH_QUANTIZED_H */
